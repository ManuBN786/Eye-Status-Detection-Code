-----------------------------------------------------------------------------
Driver’s Sleepiness Detection System, Version 1.0


Copyright (c) 2007, Idit G.  All rights reserved.
...
3. From the Matlab Command Window, run the function 'ExtractMovie(movieFileName,radius, HoughThreshold, EdgeThreshold)'
   There are 2 AVI file in the zipped directory (When trying to add more files it's impossible send via mail. Folder size is too big).
